...
for (file_name, data_col, _), _ in zip(file_list, color_list):
...
for (file_name, data_col, method), color in zip(file_list, color_list):
    ...
    if method == 'expfit':
        ...
        T_fit = savgol_filter(T, smooth_window, 2)
...
ax.set_ylabel('T (°C)', fontdict={'weight': 'bold'})
